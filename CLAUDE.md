...
- `internal/domain/entities/upgrade_shop.go` — Unified `UpgradeShop` with `NewUpgradeShopFromConfig()` constructor
- `internal/domain/entities/item_shop.go` — Unified ItemShop with `NewItemShopFromConfig()` constructor
